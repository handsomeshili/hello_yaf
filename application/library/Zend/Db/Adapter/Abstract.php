 ...
 * @see Zend_Db_Select
 */
require_once APPLICATION_PATH . '/library/Zend/Db/Select.php';
...
abstract class Zend_Db_Adapter_Abstract
{
    ...
    public function query($sql, $bind = array())
    {
        ...
        //yangyang added in 2013-08-21
        Yaf_Registry::set('last_sql_string', $sql);
        Yaf_Registry::set('last_sql_data', $bind);
